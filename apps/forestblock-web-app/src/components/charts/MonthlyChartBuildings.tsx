...
export interface MonthlyBuildingRecord {
  month: string;
  [buildingKey: string]: string | number;
}

interface MonthlyChartBuildingsProps {
  data: MonthlyBuildingRecord[];
  seriesKeys: string[];
  colors: { [key: string]: string };
}

const MonthlyChartBuildings: React.FC<MonthlyChartBuildingsProps> = ({
  data,
  seriesKeys,
  colors,
}) => {
...
export default MonthlyChartBuildings;
